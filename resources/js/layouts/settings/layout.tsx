        ...
        <main className="flex-1 bg-slate-50 px-4 py-6 pb-28 text-slate-950 sm:px-7 sm:py-8 md:pb-8 lg:px-8 dark:bg-[#050b18] dark:text-white">
            <div className="mx-auto max-w-5xl">
                <header className="mb-7">
                    ...
                    <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Manage your profile, security, and appearance.</p>
                </header>
                ...
                <aside className="w-full lg:sticky lg:top-6 lg:w-56 lg:shrink-0">
                    <nav className="grid grid-cols-3 gap-2 rounded-2xl border border-slate-200 bg-white p-2 lg:grid-cols-1 dark:border-slate-800 dark:bg-[#091122]">
