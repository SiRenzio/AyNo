                    ...
                    <div className="grid min-w-0 grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)] items-center gap-1.5">
                        <label className="min-w-0">
                            ...
                            <input
                                ...
                                className="h-11 w-full min-w-0 rounded-lg border border-slate-300 bg-slate-50 px-1 text-center text-base font-semibold outline-none focus:border-blue-500 dark:border-slate-700 dark:bg-[#080f20]"
                            />
                        </label>
